...
function circle2(diameter){
    return diameter * Math.PI
}
console.log(Math.round(circle2("12")));
...
function check(outcome){
     ...
     if (outcome < 0.5){
         return outcome + " Het glas is half leeg"
     } else {
         return outcome + " Het glas is half vol"
     }
}
console.log(check(outcome));