...
console.log("\n");
console.log(story.substring(0, (story.indexOf("F")-1))); //story.indexOf("F")-1) zoekt naar de F in de string.
...
// console.log(price);
// console.log("\n");
// console.log(price.replace("$","€") && price.replace(".",","));
// console.log("\n");
// console.log(price.replace("$","€") || price.replace(".",","));
